                            ...
                            <tr>
                                ...
                                <td class="">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button class="btn btn-success open-modal" data-empid="{{$user->id}}" data-status="commend" data-name="{{$user->fname. ' ' . $user->lname}}">
                                            <i class="fas fa-award"></i>&nbsp;Commend</button>
            ...
            success:function(data) {
                ...
                $.each(data, function(key, val){
                    $('#emp_body').append("<tr><td>"+val.name+"</td><td>"+val.position+"</td><td>"+val.date_hired+"</td><td>"+val.monthly_rate+"</td>"+
                        "<td>"+
                        "<button class='btn btn-success open-modal mr-1' data-empid="+val.id+" data-status='commend' data-name="+val.name+"><i class='fas fa-award'></i>&nbsp;Commend</button>"+
